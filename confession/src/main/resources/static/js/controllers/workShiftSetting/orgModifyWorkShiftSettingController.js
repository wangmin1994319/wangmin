 ...
 */
'use strict';
app.controller('orgModifyWorkShiftSettingController',['$modalInstance', 'moment', '$modal', '$http', '$scope', '$localStorage', 'workShift', function($modalInstance, moment,$modal,$http,$scope,$localStorage,workShift) {
    ...
    $scope.submit = function(){
        ...
        $http.put('/attds/workShiftSettings/'+$scope.workShiftSetting.id, $scope.workShiftSetting).success(function(data){
            if(data){

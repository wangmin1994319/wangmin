 ...
 *
 *  @version 1.2.1
 *  comments: Accounding to 史魁�?'s comments, markers' watcher should have set deep watch equal to true, and previous overlaies should be removed
 *
 */
            ...
            link: function($scope, element, attrs) {
                ...
                var map_init = function() {
                    ...
                    map.addEventListener("click", function (e) {
                        ...
                        $scope.options.lon = e.point.lng, $scope.options.lat = e.point.lat;
                        var marker = new BMap.Marker(point);
                        var myGeo = new BMap.Geocoder();
                        myGeo.getLocation(new BMap.Point(e.point.lng, e.point.lat), function(result){
                            if (result){
                                $scope.options.address = result.address;
                            }
                        });
                        map.clearOverlays();
                ...
                setTimeout(function(){map_init();},200);
            },
